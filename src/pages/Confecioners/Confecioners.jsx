      ...
      <div className={styles.confItem}>
        <div className={styles.confAvatar}>
          ...
          <p className={styles.confAvatarInfo}>
            Кондитер IV разряда и автор «Школа юного кондитера» Рекордсмен книги рекордов...
          </p>
          ...
          <div className={styles.confSubInfo}>
            ...
            <div className={styles.confBtnList}>
              ...
              <div className={styles.confBtnContainer}>
                <button className={styles.confNextBtn}><img src={arrowLeft} alt="Arrow Left" /></button>
                <button className={styles.confNextBtn}><img src={arrowRight} alt="Arrow Right" /></button>
              </div>
            </div>
          </div>
          <div className={styles.ConfCakeList}>
            <div className={styles.ConfCakeItem}>
              <div className={styles.confCakeItemImg}><img src={cake1} /></div>
            ...
            <div className={styles.ConfCakeItem}>
              <div className={styles.ConfCakeItemImg}><img src={cake2} /></div>
              <div className={styles.ConfCakeItemWrap}>
                <h2>520 грн</h2>
            ...
            <div className={styles.ConfCakeItem}>
              <div className={styles.ConfCakeItemImg}><img src={cake3} /></div>
              <div className={styles.ConfCakeItemWrap}>
                <h2>520 грн</h2>
            ...
            <div className={styles.ConfCakeItem}>
              <div className={styles.ConfCakeItemImg}><img src={cake4} /></div>
              <div className={styles.ConfCakeItemWrap}>
                <h2>520 грн</h2>
