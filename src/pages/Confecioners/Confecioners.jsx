...
import css from "./Confecioners.module.css";
        ...
        <div className={css.confectionersSection}>
          {[...Array(4)].map((_, index) => (
            <div key={index} className={css.confectionerCard}>
              <Link to="/confectioner/about" className={css.confectionerHeader}>
                <img
                  src={aboutConfectionerImg}
                  alt="confectioner"
                  className={css.confectionerImage}
                />
