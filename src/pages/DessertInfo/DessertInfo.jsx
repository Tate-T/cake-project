            ...
            <Container>
                ...
                <div className={css.boxinfo__cake__full}>
                    <ul className={css.imgInfo__list}>
                        ...
                        <li>
                            <img className={css.info__imgS} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLL4fFJ89AKwQvC2IumQE8Ywqij2hMgVRVLw&s' alt='1'></img>
                        </li>
                        <li>
                            <img className={css.info__imgS} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLL4fFJ89AKwQvC2IumQE8Ywqij2hMgVRVLw&s' alt='2'></img>
                        </li>
                        <li>
                            <img className={css.info__imgS} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLL4fFJ89AKwQvC2IumQE8Ywqij2hMgVRVLw&s' alt='3'></img>
                        </li>
                        <li>
                            <img className={css.info__imgS} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLL4fFJ89AKwQvC2IumQE8Ywqij2hMgVRVLw&s' alt='4'></img>
                        </li>
                        <button type='button'>
                            <svg width="12.000000" height="7.410156" viewBox="0 0 12 7.41016" fill="none" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
                                <desc>
                    ...
                    <div className={css.box__info__cake}>
                        <img className={css.info__imgB} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSLL4fFJ89AKwQvC2IumQE8Ywqij2hMgVRVLw&s' alt='2'></img >
                        ...
                        <div className={css.BoxInfo__text__Cake}>
                            ...
                            <TitleCake >Торт “Червоний оксамит”</TitleCake >
                            <PriceTextCake>670 грн</PriceTextCake>
                            <TextCake>2 кг
                                <span></span>
                            ...
                            <TextCake> Цей торт особливо актуальний до Дня святого Валентина. Ви тільки подивіться, який він пристрасний!) І смачний звичайно. І з приготуванням впорається будь-хто! Загалом все, як ми любимо! Тому цей
                                ...
                                (Roha), або гелевий Americolor Red Red.</TextCake>
                            <button className={css.ButtonListCake}>
                                <li>
                                    <ButtonCake type="button">Обрати параметри</ButtonCake>
                                </li>
                                <li>
                                    <ButtonCake type="button">Переглянути контакти</ButtonCake>
                                </li>
                                <li>
                                    <button type="button" className={css.loading__btn}><svg width="20.000000" height="18.349609" viewBox="0 0 20 18.3496" fill="none" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
                                        <desc>
                                            Created with Pixso.
                                        </desc>
                                        <defs />
